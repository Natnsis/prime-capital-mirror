    ...
    <section className="w-full bg-white py-16">
      <div className="flex flex-col md:flex-row items-start justify-between w-full gap-10 md:gap-16 px-6 md:px-12">
        ...
        <div className="flex-shrink-0 relative w-full md:w-[380px] lg:w-[450px] flex justify-center">
          <div className="w-full h-64 md:h-80 bg-white rounded-3xl shadow-lg border border-gray-100 transform rotate-3 hover:rotate-0 hover:border-primary transition-transform duration-500 ease-out overflow-hidden">
            <img
              src="/home.png"
